...
class PostModel extends Model
{
    ...
    const COLUMNS = ['id', 'alias_id', 'group_id', 'user_id', 'type', 'comment_count', 'collection_count', 'upvote_count', 'is_top', 'is_essence', 'created_at', 'updated_at', 'is_deleted'];

    // List of columns which have a default value or are nullable
    const OPTIONAL_COLUMNS = ['comment_count', 'collection_count', 'upvote_count', 'is_top', 'is_essence', 'created_at'];
